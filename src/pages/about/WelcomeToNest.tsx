...
import { welcomeToNestCont, welcomeToNestContent, welcomeToNestContentImgCont, welcomeToNestMainImg } from "../../style/pages/about/welcomeToNest";
  ...
  return (
    <section className={css(flex.raw({gap: 'xlg'}), welcomeToNestCont)}>
      ...
      <div className={css(welcomeToNestContent)}>
        ...
        <div className={css(flex.raw({gap: 'md', type: 'spaceAroundStart'}), welcomeToNestContentImgCont)}>
          <figure>
